...
public final class FileGlobalLockManager implements GlobalLockManager {
    ...
    @Override public void acquire(String resourceId, String tableName, String primaryKey, String xid) {
        ...
        try {
            ...
            throw new AtException("Global lock conflict: " + resourceId + "/" + tableName + "/" + primaryKey);
