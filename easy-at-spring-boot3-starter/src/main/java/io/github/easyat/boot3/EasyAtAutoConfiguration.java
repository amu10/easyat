...
import io.github.easyat.core.*; import io.github.easyat.jdbc.*; import io.github.easyat.spring.*; import io.github.easyat.storage.file.*; import org.springframework.boot.autoconfigure.AutoConfiguration; import org.springframework.boot.autoconfigure.condition.*; import org.springframework.boot.web.servlet.FilterRegistrationBean; import org.springframework.context.annotation.Bean; import javax.sql.DataSource; import java.nio.file.Paths; import java.util.Map;
@AutoConfiguration @ConditionalOnClass(EasyAtAspect.class)
