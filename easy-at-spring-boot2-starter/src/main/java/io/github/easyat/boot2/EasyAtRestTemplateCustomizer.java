...
public final class EasyAtRestTemplateCustomizer implements RestTemplateCustomizer {
    ...
    public EasyAtRestTemplateCustomizer(AtRestTemplateInterceptor interceptor){this.interceptor=interceptor;}
    @Override public void customize(RestTemplate restTemplate){restTemplate.getInterceptors().add(interceptor);}
}
