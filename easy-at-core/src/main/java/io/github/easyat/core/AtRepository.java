...
public interface AtRepository {
  ...
  /** Candidate global transactions that need recovery (timeout / rollback-failed / still rolling back). */
  ...
  /** Atomically take over recovery ownership. Succeeds when free, already owned by us, or lease expired. */
