...
/**
 * Optional repository capability for writing undo information through the
 * connection that executes the business DML. Implementations must not commit
 * or close that connection.
 */
